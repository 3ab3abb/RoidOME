...
// STATISTICS TRACKER - Might be usesful after 
...
async fn main() {
        ...
        let stats = Arc::new(Mutex::new (EventStats { 
        temperature : 0 , 
        motion : 0 ,
        gas : 0 , 
        errors : 0 , 
    ...
    ("home/sensors/motion",      r#"{"id":"esp32_03","motion":false,"timestamp":1234567891}"#),
            ...
            match router(&topic , &payload) { 
                ...
                Ok(event) => {  
                    ...
                    match event {
                        ...
                        DeviceEvent::TemperatureHumidity(_) =>s.temperature +=1 , 
                        DeviceEvent::Motion(_)=>s.motion +=1 , 
                        DeviceEvent::Gas(_)=>s.gas +=1 , 
        ...
        println!("Temperature Readings : {}" ,p.temperature) ;
        println!("Motion Readings : {}",p.motion) ; 
        println!("Gas Readings : {}",p.gas) ; 
